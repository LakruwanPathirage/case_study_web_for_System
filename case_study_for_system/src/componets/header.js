...
class Header extends Component {
  render() {
    return (
      <div class="d-flex bg-custom-cl p-3">
        <div class="align-self-start logoimage d-none d-md-inline-block">
          <img
            src={image}
            alt=""
        ...
        <div className="align-self-start ml-auto head">
          ...
          <button type="button" class="btn btn-outline-light logout ">
            log out
          </button>
        </div>
      </div>
